...
stroke_data <- read.csv("../data/train_allnumeric_notoversampled_imputed_reformatted_JB.csv")
stroke_data_oversampled <- read.csv("../data/train_allnumeric_oversampled_imputed_JB.csv")
# Remove id column
...
#                                                 'Smoking status'),
#                                   vectorize=FALSE)
list_features <- c("gender", "age", "hypertension", "heart_disease", "ever_married",
